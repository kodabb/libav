...
FATE_SAMPLES_AVCONV-$(call DEMDEC, DSS, DSS_SP) += fate-dss-sp fate-dss-lp
fate-dss-sp: CMD = framecrc -i $(TARGET_SAMPLES)/dss/sp.dss
fate-dss-lp: CMD = framecrc -i $(TARGET_SAMPLES)/dss/lp.dss
