...
# ipcm_C_NEC_2.bit
# ipcm_D_NEC_2.bit
# NUT_A_ericsson_4.bit (frame checksums match, but overall md5 is different -- missing frames?)
# PPS_A_qualcomm_7.bit
# RAP_B_Bossen_1.bin
# RPS_C_ericsson_4.bit
# TSUNEQBD_A_MAIN10_Technicolor_2.bit (segfault)
# WPP_D_ericsson_MAIN_2.bit (segfault)
# WPP_D_ericsson_MAIN10_2.bit

define FATE_HEVC_SEI_TEST
FATE_HEVC += fate-hevc-conformance-$(1)
fate-hevc-conformance-$(1): CMD = avconv -f hevc -i $(TARGET_SAMPLES)/hevc-conformance/$(1).bit -f null -
...
# POC_A_Bossen_3.bin
# RAP_A_docomo_4.bit
# SAO_C_Samsung_4.bin -- no checksums provided
# SAO_D_Samsung_4.bin -- same
# STRUCT_A_Samsung_5.bin -- same
# STRUCT_B_Samsung_4.bit -- same
# SLIST_A_Sony_4.bit
# SLIST_B_Sony_8.bit (segfault)
# SLIST_C_Sony_3.bit
# SLIST_D_Sony_9.bit
# TILES_A_Cisco_2.bin
# TILES_B_Cisco_1.bin
...
FATE_HEVC += fate-hevc-conformance-$(1)
fate-hevc-conformance-$(1): CMD = framecrc -f hevc -i $(TARGET_SAMPLES)/hevc-conformance/$(1).bit
endef
