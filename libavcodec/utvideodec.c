                        ...
                        AVPacket *avpkt)
{
    ...
    if (c->interlaced)
        // fields are coded ortogonally, not bff or tff
        ff_avframe_fieldstate_set(frame.f, AV_FRAME_INTERLACED);
    else
        ff_avframe_fieldstate_set(frame.f, AV_FRAME_PROGRESSIVE);
