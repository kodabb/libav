...
void ff_xface_generate_face(uint8_t *dst, uint8_t *const src)
{
    ...
    for (j = 0; j < XFACE_HEIGHT; j++) {
        for (i = 0; i < XFACE_WIDTH; i++) {
            ...
            /*
             * Compute k, encoding the bits *before* the current one, contained
             ...
             * In case the pixel is near the border of the grid, the number of
             ...
             * on the position of the pixel, and shows the corresponding guess
             * table to use:
             *
