...
static int decode_slice_header(FFV1Context *f, FFV1Context *fs)
{
    ...
    if (ps == 1)
        ff_avframe_fieldstate_set(f->cur, AV_FRAME_INTERLACED_TFF);
    else if (ps == 2)
        ff_avframe_fieldstate_set(f->cur, AV_FRAME_INTERLACED_BFF);
    else if (ps == 3)
        ff_avframe_fieldstate_set(f->cur, AV_FRAME_PROGRESSIVE);
