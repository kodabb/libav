...
static int select_frame(AVFilterContext *ctx, AVFrame *frame)
{
    ...
    select->var_values[VAR_INTERLACE_TYPE] =
        ff_avframe_fieldstate_get(frame) & AV_FRAME_PROGRESSIVE ? INTERLACE_TYPE_P :
        ff_avframe_fieldstate_get(frame) == AV_FRAME_INTERLACED_TFF ? INTERLACE_TYPE_T : INTERLACE_TYPE_B;
